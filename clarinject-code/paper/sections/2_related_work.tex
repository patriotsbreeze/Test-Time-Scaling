...
openai2024instructhierarchy, anthropic2024instructionhierarchy}. Our work complements
this line by identifying an interaction-\emph{state} amplifier that is orthogonal
to the delivery channel: the same payload is more dangerous when it arrives as a
...
clarification quality beyond task completion. Our work introduces the first \emph{safety}
dimension to this literature: clarification has a security cost that practitioners
need to account for.
