...
\begin{enumerate}
  ...
  \item \textbf{Empirical validation.} Experiments with 50 independent runs confirm
    ...
    achieves $8.5\%$ fewer calls at $0.4$-percentage-point cost, with larger gains
    expected for PRMs with continuous score outputs
...
reduction. On real Math-Shepherd PRM data, the gain is $8.5\%$ due to the high
effective Lipschitz constant of binary step labels; PRMs with smooth, continuous
