...
\begin{enumerate}
  ...
  \item \textbf{Empirical validation.} Simulated tree-search experiments confirm
    the theoretical rates and demonstrate a $55{-}70\%$ reduction in verifier
    calls with ${\leq}3\%$ accuracy loss relative to exhaustive verification
...
steps, DVA-MCTS requires $\approx 160$ verifier calls versus $1600$ for uniform
allocation, a $10\times$ reduction that is particularly valuable when the verifier
is a large neural network executed on dedicated hardware.
