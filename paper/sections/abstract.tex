...
DVA-MCTS achieves an $8.5\%$ call reduction at $0.4$-percentage-point accuracy cost,
with larger savings expected for PRMs with continuous (rather than binary) score outputs.
