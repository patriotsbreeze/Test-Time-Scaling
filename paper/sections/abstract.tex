...
at $T \approx K^D$. On $100$ real GSM8K problems using Math-Shepherd PRM annotations,
DVA-MCTS achieves an $8.8\%$ call reduction while improving accuracy by $3.6$ percentage
points over exhaustive verification, with larger savings expected for PRMs with continuous
